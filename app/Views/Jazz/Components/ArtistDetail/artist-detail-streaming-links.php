...
<section aria-labelledby="streaming-links-heading">
    <h2 id="streaming-links-heading" class="text-2xl font-bold mb-4" style="font-family: 'Cormorant Garamond', serif;">
        Available On
    </h2>
    ...
    <nav aria-label="Streaming and social links" class="flex flex-wrap gap-4">
        ...
        <a href="<?= htmlspecialchars($artist->spotify_url) ?>" target="_blank" rel="noopener noreferrer"
        ...
        <a href="<?= htmlspecialchars($artist->youtube_url) ?>" target="_blank" rel="noopener noreferrer"
        ...
        <a href="<?= htmlspecialchars($artist->soundcloud_url) ?>" target="_blank" rel="noopener noreferrer"
