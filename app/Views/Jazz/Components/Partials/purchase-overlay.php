...
<dialog id="purchase-overlay" class="w-full max-w-lg rounded-2xl shadow-2xl p-0 bg-white border-0
               backdrop:bg-black/40 backdrop:backdrop-blur-sm" aria-labelledby="purchase-overlay-title"
    aria-modal="true">
    ...
    <article class="flex flex-col">
        ...
        <button type="button" data-action="close-overlay"
            class="self-end mt-4 mr-4 text-gray-400 hover:text-gray-600 transition-colors
                       focus:outline-none focus-visible:ring-2 focus-visible:ring-[var(--pastel-lavender)] rounded-full p-1" aria-label="Close dialog">
        ...
        <section id="overlay-state-select" aria-label="Select ticket quantity">
            ...
            <header class="flex flex-col items-center px-8 pb-2 text-center">
                <h2 id="purchase-overlay-title" class="text-2xl font-bold text-gray-900"
            ...
            <section class="mx-6 mb-6" aria-label="Ticket quantity">
                ...
                <div class="flex items-center gap-4">
                    <button type="button" data-action="qty-decrease" class="w-10 h-10 flex items-center justify-center rounded-full border-2
                                   ...
                                   disabled:opacity-30 disabled:cursor-not-allowed" aria-label="Decrease quantity">
                        &minus;
                    </button>

                    <output id="ticket-qty" class="w-12 text-center text-2xl font-extrabold text-gray-900"
                        aria-live="polite" aria-atomic="true">
                        1
                    </output>

                    <button type="button" data-action="qty-increase" class="w-10 h-10 flex items-center justify-center rounded-full border-2
                                   border-[var(--pastel-lavender)] text-[var(--pastel-lavender)]
                                   text-xl font-bold hover:bg-[var(--pastel-lavender)]/10 transition-colors
                                   focus:outline-none focus-visible:ring-2 focus-visible:ring-[var(--pastel-lavender)]"
            ...
            <footer class="flex flex-col sm:flex-row gap-3 px-6 pb-6">
                <button type="button" data-action="close-overlay" class="flex-1 py-3 px-5 rounded-full border-2 border-gray-300 text-gray-500
                               font-semibold text-sm hover:border-gray-400 transition-colors
                               focus:outline-none focus-visible:ring-2 focus-visible:ring-gray-400">
                    Cancel
                </button>
                <button type="button" id="overlay-add-btn" data-action="confirm-purchase" class="flex-1 py-3 px-5 rounded-full bg-[var(--pastel-lavender)] text-white
        ...
        <section id="overlay-state-confirm" class="hidden" aria-label="Purchase confirmation">
            ...
            <header class="flex flex-col items-center px-8 pb-4 text-center">
                ...
                <h2 class="text-2xl font-bold text-gray-900" style="font-family: 'Cormorant Garamond', serif;">
                ...
                <div class="flex items-stretch">
                    ...
                    <div class="flex-1 px-4 py-4">
                        ...
                        <footer class="flex items-center justify-between mt-3">
                            <mark id="confirm-ticket-label" class="bg-[var(--pastel-lavender)]/15 text-[var(--pastel-lavender)]
            ...
            <!-- Cart summary -->
            <section
                class="mx-6 mb-6 flex items-start justify-between text-sm text-gray-600 border-t border-gray-100 pt-4"
            ...
            <footer class="flex flex-col sm:flex-row gap-3 px-6 pb-6">
                <button type="button" data-action="close-overlay" class="flex-1 py-3 px-5 rounded-full border-2 border-[var(--pastel-lavender)]
                               text-[var(--pastel-lavender)] font-semibold text-sm
                               hover:bg-[var(--pastel-lavender)]/10 transition-colors
                               focus:outline-none focus-visible:ring-2 focus-visible:ring-[var(--pastel-lavender)]">
                    Continue Shopping
                </button>
                <a href="/payment" class="flex-1 py-3 px-5 rounded-full bg-[var(--pastel-lavender)] text-white
