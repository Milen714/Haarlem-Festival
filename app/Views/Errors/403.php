...
<body class="flex flex-col min-h-screen bg_colors_home">
    <main class="flex-grow flex items-center justify-center px-6 py-24">
        <div class="text-center">
            <h1 class="text-9xl font-bold text-[var(--home-gold-accent)] mb-4">403</h1>

            <h2 class="text-3xl font-semibold text_colors_home mb-2">Access Denied</h2>
            <p class="text-lg text-gray-500 mb-8 max-w-md mx-auto">
                Sorry, you don't have permission to access this resource. If you believe this is an error, please
                contact support.
            </p>
