    ...
    <div class="flex h-screen overflow-hidden">
        ...
        <aside id="cms-sidebar"
            ...
            <nav class="flex-1 px-2 py-4 space-y-1 overflow-y-auto">
                ...
                <a href="/cms/schedules" class="cms-nav-link flex items-center px-4 py-2 rounded-lg"
                    style="color: #9CA3AF;">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <a href="/cms/restaurants" class="cms-nav-link flex items-center px-4 py-2 rounded-lg"
                    ...
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M3 3h2v18H3V3zm4 0v7a4 4 0 004 4V3h-1v6H9V3H8v6H7V3h-.001zM17 3c-1.5 0-3 1.5-3 4.5S15.5 12 17 12v9h-1V3z" />
                    </svg>
                    <span>Restaurants</span>
                </a>

                <a href="/cms/landmarks" class="cms-nav-link flex items-center px-4 py-2 rounded-lg"
                    style="color: #9CA3AF;">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M3 21h18M6 21V10M18 21V10M12 3L2 10h20L12 3zM10 21v-4a2 2 0 014 0v4" />
                    </svg>
                    <span>Landmarks</span>
                </a>
                ...
                <!-- Tools Section -->
                <div class="pt-4">
                    <p class="px-4 text-xs font-semibold uppercase tracking-wider" style="color: #6B7280;">Tools</p>
                </div>

                <a href="/cms/export-orders" class="cms-nav-link flex items-center px-4 py-2 rounded-lg"
                    style="color: #9CA3AF;">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                    </svg>
                    <span>orders Export</span>
                </a>
