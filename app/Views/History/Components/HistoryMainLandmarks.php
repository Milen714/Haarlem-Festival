<section class="mt-8 space-y-8">
    <article class="grid md:grid-cols-5 gap-6 items-start">
        ...
        <div class="md:col-span-3 bg-neutral-50 rounded-lg border border-neutral-200 shadow-card p-6">
    ...
    <article class="grid md:grid-cols-5 gap-6 items-start">
        <div class="md:col-span-3 order-2 md:order-1 bg-neutral-50 rounded-lg border border-neutral-200 shadow-card p-6">
