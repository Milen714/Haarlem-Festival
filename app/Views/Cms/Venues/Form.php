            ...
            <div class="bg-white border rounded-lg p-6 mb-6">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" 
                        id="name" 
                        name="name" 
                        value="<?= htmlspecialchars($venue->name ?? '') ?>"
            ...
            <div class="bg-white border rounded-lg p-6 mb-6">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" 
                        ...
                        class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                        placeholder="e.g., Grote Markt 16"
                        required>
                </div>
                ...
                <div class="grid grid-cols-2 gap-4 mb-4">
                    ...
                    <div>
                        ...
                        <input type="text" 
                            id="city" 
                            name="city" 
                            value="<?= htmlspecialchars($venue->city ?? 'Haarlem') ?>"
                            class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                            required>
                    </div>
                ...
                <div class="mb-4">
                    ...
                    <input type="text" 
                        id="country" 
                        name="country" 
                        value="<?= htmlspecialchars($venue->country ?? 'NL') ?>"
                        class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                </div>
            </div>
            ...
            <div class="bg-white border rounded-lg p-6 mb-6">
                ...
                <div class="mb-4">
                    ...
                    <input type="tel" 
                        id="phone" 
                        name="phone" 
                        value="<?= htmlspecialchars($venue->phone ?? '') ?>"
                        class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                ...
                <div class="mb-4">
                    ...
                    <input type="email" 
                        id="email" 
                        name="email" 
                        value="<?= htmlspecialchars($venue->email ?? '') ?>"
                        class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
