...
?>
    ...
    <section class="relative bg-[var(--yummy-primary)] text-white">
      <div class="absolute inset-0">
        <img
          src="..<?= htmlspecialchars($heroSection->media->file_path ?? '../Assets/Yummy/Home/hero.webp') ?>"
      ...
      >
        <h1 class="text-4xl font-semibold mb-4"><?= htmlspecialchars($heroSection->title ?? 'Yummy!') ?></h1>
          <?= htmlspecialchars($heroSection->content_html ?? 'Welcome to the Yummy Haarlem Festival, where culinary delights await you! Explore the vibrant food scene of Haarlem and indulge in a gastronomic adventure like no other.') ?>
