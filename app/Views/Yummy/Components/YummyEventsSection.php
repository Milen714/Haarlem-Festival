...
<section class="bg-[var(--yummy-sec-section)] py-16 px-6 gap-6">
      ...
      <div class="grid md:grid-cols-4 gap-6 max-w-6xl mx-auto">
        ...
        <div class="bg-white rounded shadow text-center">
          <img
            src="/app/public/Assets/Magic/AltHeroImage.png"
            class="rounded-t"
            alt="Magic Festival"
          />
          <div class="p-4">
        ...
        <div class="bg-white rounded shadow text-center">
          <img
            src="/app/public/Assets/History/History_Church_1.png"
            class="rounded-t"
        ...
        <div class="bg-white rounded shadow text-center">
          <img
            src="/app/public/Assets/Dance/DanceHome/69a41a0ad1451_1772362250.webp"
            class="rounded-t"
            alt="Dance Festival"
          />
          <div class="p-4">
