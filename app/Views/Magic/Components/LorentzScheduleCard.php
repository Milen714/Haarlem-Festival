...
<section class="flex flex-row border-2 border-[var(--magic-bright-gold-accent)] rounded-lg w-[45%]">
    <section
        class="flex flex-col md:flex-row border border-[var(--magic-border-transperent-dark)] w-full rounded-lg overflow-hidden">
        <div
            class="flex flex-col items-center justify-center h-full p-4 md:p-5 text-xl md:text-2xl text-[var(--magic-bright-gold-accent)] font-courierprime bg-[#07202A] md:w-28">
            <h3><?= $day ?></h3>
        </div>
        <div class="w-full bg-[#1A2B4C] text-center px-3 md:px-0">
