...
<section class="bg-white p-6 rounded-lg shadow-sm border border-gray-100 w-full md:w-[25%] flex flex-col">
    ...
    <div class="mt-8 mb-3 flex justify-between items-end">
        ...
        <span class="text-3xl font-bold text-black">€<?= number_format((float)($viewModel?->total ?? 0.0), 2) ?></span>
    </div>
