...
echo 'Hello world!';
echo '<br/>';
echo '<a href="/login?param=value">To Loginn</a>';
echo '<br/>';
echo '
            <form method="GET" action="/login">
    <article class="input_group">
        <label class="input_label" for="email">Email:</label>
        <input class="form_input" type="text" id="email" name="param" >
    ...
    <article class="input_group">
        <label  class="input_label" for="picture">Take a picture using back facing camera:</label>
...
<iframe data-testid="embed-iframe" style="border-radius:12px"
    src="https://open.spotify.com/embed/track/1EDPVGbyPKJPeGqATwXZvN?utm_source=generator" width="100%" height="352"
...
<iframe data-testid="embed-iframe" style="border-radius:12px"
    src="https://open.spotify.com/embed/track/1LEvJeOgNbBQZOfYgd0gP5?utm_source=generator" width="100%" height="352"
    frameBorder="0" allowfullscreen=""
    allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture" loading="lazy"></iframe>